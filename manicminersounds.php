...
<html>
    ...
    <body>
        <h2><a href="<?php echo $webURL; ?>">↵</a> MANIC MINER sound tester</h2>
        <?php
            echo "<script src='manicminersounds.js?ver=".$srcVersion."'></script>";
            $colors = [
            ...
            $buttons = [
                ...
                "fallingKongSound" => ["status" => "ok", "binStatus" => "ok"],
                "escapeSound" => ["status" => "ok", "binStatus" => "false"],
                "tapeLoadSound" => ["status" => "ok", "binStatus" => "ok"],
