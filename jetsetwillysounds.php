    ...
    <body>
        ...
        <?php
            ...
            $buttons = [
                ...
                "gameMusic7" => ["status" => "empty", "binStatus" => "ok"],
                "gameMusic6" => ["status" => "empty", "binStatus" => "ok"],
                "gameMusic5" => ["status" => "empty", "binStatus" => "ok"],
                "gameMusic4" => ["status" => "empty", "binStatus" => "ok"],
                "gameMusic3" => ["status" => "empty", "binStatus" => "ok"],
                "gameMusic2" => ["status" => "empty", "binStatus" => "ok"],
                "gameMusic1" => ["status" => "empty", "binStatus" => "ok"],
                "gameMusic0" => ["status" => "empty", "binStatus" => "ok"],
                "itemSound" => ["status" => "empty", "binStatus" => "ok"],
                "arrowSound" => ["status" => "empty", "binStatus" => "ok"],
