    ...
    <body>
        ...
        <?php
            ...
            $buttons = [
                ...
                "gameMusic5" => ["status" => "prepare", "binStatus" => "ok"],
                "gameMusic4" => ["status" => "prepare", "binStatus" => "ok"],
                "gameMusic3" => ["status" => "prepare", "binStatus" => "ok"],
                "gameMusic2" => ["status" => "prepare", "binStatus" => "ok"],
                "gameMusic1" => ["status" => "prepare", "binStatus" => "ok"],
                "gameMusic0" => ["status" => "prepare", "binStatus" => "ok"],
