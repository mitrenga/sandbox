...
<html>
  ...
  <body>
    ...
    <label for="sprite-dimension">sprite dimension: </label><select id="sprite-dimension"><option value="0808">8 x 8</option><option value="1616" selected>16 x 16</option></select><br>
